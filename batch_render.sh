...
cd ../rendering_tools
python df2net_render_no_tex.py --conf ../shugao_facestar.json
cd ../rendering_tools
...
echo -e "${RED}${ALG_NAME}, using ${CONDA_DEFAULT_ENV}${NC}"
cd ../MGCNet
python test_image.py --conf ../shugao_facestar.json
cd ../rendering_tools
...
echo -e "${RED}${ALG_NAME}, using ${CONDA_DEFAULT_ENV}${NC}"
cd ../rendering_tools
python deep3dfaceR_render_no_tex.py --conf ../shugao_facestar.json
cd ../rendering_tools
...
echo -e "${RED}${ALG_NAME}, using ${CONDA_DEFAULT_ENV}${NC}"
cd ../rendering_tools
python prnet_render.py --conf ../shugao_facestar.json
cd ../rendering_tools
...
echo -e "${RED}${ALG_NAME}, using ${CONDA_DEFAULT_ENV}${NC}"
cd ../rendering_tools
python face_normals_render.py --conf ../shugao_facestar.json
cd ../rendering_tools
